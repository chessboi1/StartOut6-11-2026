...
public class FConstants {
    static {
        ...
        FollowerConstants.leftFrontMotorName = "Left_Motor1";
        FollowerConstants.leftRearMotorName = "Left_Motor2";
        FollowerConstants.rightFrontMotorName = "Right_Motor1";
        FollowerConstants.rightRearMotorName = "Right_Motor2";
